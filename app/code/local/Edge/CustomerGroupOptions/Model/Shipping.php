...
class Edge_CustomerGroupOptions_Model_Shipping extends Mage_Shipping_Model_Shipping
{
    ...
    protected function _setAvailableCarriers() {
        if($this->availableCarriers == null){
            $this->availableCarriers = Mage::getModel('customergroupoptions/customerGroupOptions')->getAvailableShippingMethodsByGroupId(Mage::getSingleton('customer/session')->getCustomerGroupId());
        }
    }
}
